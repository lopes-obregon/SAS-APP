...
export default function Home() {
  ...
  console.log("Permissão:", user?.permissao === "2");
  return (
        ...
        >
          ...
          >
            <Box rounded="md" flexDir="row" alignItems="center">
              ...
              <Heading marginLeft={4} size="sm" color="#408755">
                OLÁ SR(a) {user?.nome}!
              </Heading>
            </Box>
            <Box rounded="md" flexDir="row" alignItems="center">
              ...
              <TouchableOpacity>
                <Icon as={Feather} name="menu" size={7} color="#408755" />
              </TouchableOpacity>
            </Box>
          </HStack>
          <HStack
          ...
          >
            {user?.permissao === "2" ? (
              ...
              >
                <TouchableOpacity
                  onPress={() =>
                    navigation.navigate("Agendamento", { user: user })
                  }
                >
                  <Icon
                    as={Feather}
